...
public class HashSetExample {
	...
	public static void main(String[] args) {
		/* # Set
		 - 집합을 구현해 놓은 클래스
		 - 요소로 같은 값이 들어오는 것을 허용하지 않습니다.
		 
		 # Hash
		 - 어떤 값을 넣었을 때 전혀 예측하지 못할 값이 생성되어야 하는 알고리즘.
		 - 예측할 수 없는 값을 이용하기 때문에 정렬이 불가능합니다.
		 - 생성된 값으로 원래 값을 찾는 것도 불가능에 가깝습니다.
		...
		/*
		 ...
		 반복자 객체는 set 인터페이스가 제공하는 iterator()을 호출하여 얻어옵니다.
		 */
...
//		System.out.println(str2);
		...
		/* Iterator 객체의 메서드 next()를 통해 내부 요소를 하나씩 꺼내올 수 있습니다.
		  ...
		  여부를 확인하는 메서드를 통해 next()를 호출해야 합니다.*/
		
		
		while(iter.hasNext()) { //true일 때 while문 돌아감
