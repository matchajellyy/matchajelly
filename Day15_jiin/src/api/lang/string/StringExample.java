...
public class StringExample {
	...
	public static void main(String[] args) {
		...
		//charAt(인덱스) -> 해당 인덱스의 단일 문자를 리턴합니다.
		
		char c = str.charAt(4);
		System.out.println("4번 인덱스의 문자: " + c);
		
		//subString(인덱스) -> 문자열의 특정 범위의 문자를 추출합니다.
		String s2 = str.substring(6); // 6번 인덱스부터 끝까지 추출합니다.
		System.out.println(s2);
		
		//0번부터 5번 미만까지의 문자를 추출합니다.
		System.out.println(str.substring(0, 5));
		
		//length(): 문자열의 총 길이를 리턴합니다.
		System.out.println("str의 총 문자 개수: " + str.length());
		
		//indexOf(문자열): 특정 단어의 인덱스를 리턴합니다.
		...
		idx = str.indexOf("메롱");
		System.out.println("메롱의 인덱스: " + idx);
		
		//toLowerCase(), toUpperCase()
		//문자열을 각각 대문자, 소문자로 일괄 변경합니다.
