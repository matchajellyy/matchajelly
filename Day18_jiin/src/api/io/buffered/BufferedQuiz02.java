	...
	public static void main(String[] args) {
		/*
	       ...
	       3. '그만' 이라고 입력할 때까지 엔터를 포함해서 실시간으로
	        파일을 작성합니다. (write()로 작성하고 flush()로 밀어내세요)
		...
		File file = new File ("C:\\Users\\WiTHUS\\Desktop\\java_web_jiin\\file\\" + today +"file.txt" );
		...
		bw =
				new BufferedWriter(new FileWriter("C:\\Users\\WiTHUS\\Desktop\\java_web_jiin\\file" + today + "file\\" + str + ".txt"));
		...
		try {
			fr = new FileReader("C:\\Users\\WiTHUS\\Desktop\\java_web_jiin\\file" + today + "file\\" + str + ".txt");
