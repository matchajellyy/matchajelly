...
public class Identifier {
	...
	public static void main(String[] args) {
		// 꼭 지켜야 할 규칙 (안 지킬 시 에러 발생할 수 있습니다.)
...
//		int age = 40; (x)
		...
		//2. 식별자 이름은 숫자로 지정하거나 숫자로 시작하면 안 됩니다.
//		int 700 = 365; (x)
//		int 7number = 7; (x)
		int number7 = 7;
		int num7ber = 7;
...
//		int my birthday = 19970103; (x)
		int mybirthday = 19970103;
		int myBirthDay = 19970103; //camel case
		
		//4. 식별자 이름에 쓸 수 있는 특수문자는 밑줄(_), 달러기호($) 뿐입니다.
		//하지만 사용을 권장하지는 않습니다.
		//저 특수문자들은 사용하기로 약속한 곳이 다 지정되어 있습니다.
		String $hello_ = "안녕"; //되기는 되는데 지양하기~!
